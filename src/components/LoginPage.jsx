  ...
  return (
    <div className="relative flex justify-center items-center min-h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute w-1 h-1 bg-yellow-400 rounded-full top-[20%] left-[40%] opacity-70 blur-[2px] animate-twinkle"></div>
        <div className="absolute w-1 h-1 bg-yellow-300 rounded-full top-[60%] left-[70%] opacity-50 blur-[2px] animate-twinkle-delayed"></div>
        <div className="absolute w-[2px] h-[2px] bg-yellow-500 rounded-full top-[40%] left-[20%] opacity-60 blur-[1px] animate-twinkle"></div>
      </div>
      ...
      <div className="relative z-10 bg-black/95 rounded-2xl shadow-[0_0_30px_rgba(255,215,0,0.25)] hover:shadow-[0_0_45px_rgba(255,215,0,0.4)] transition-shadow duration-700 ease-in-out flex w-3/4 max-w-4xl backdrop-blur-sm">
        ...
        <div className="w-1/2 bg-gradient-to-b from-[#ffd700] via-[#d4af37] to-[#bfa34f] text-white rounded-l-2xl p-10 flex flex-col justify-between min-h-[600px] shadow-[0_0_60px_rgba(255,215,0,0.4)]">
          <div>
            ...
            {/* Headline */}
            <h1 className="text-4xl font-bold mb-4 text-black font-serif font-italic">
              WELCOME TO CRESCENTIS
            </h1>

            {/* Description */}
            <p className="mb-4 text-black/80">
              Discover a smarter way to manage your workflow with Crescentis.
              Designed to boost productivity, streamline processes, and inspire
              creativity.
            </p>
        ...
        <div className="w-1/2 p-10 flex flex-col justify-center bg-black rounded-r-2xl relative">
          ...
          <h2 className="text-2xl font-bold text-[#d4af37] mb-2">Login</h2>
